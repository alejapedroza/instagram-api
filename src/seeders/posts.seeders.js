...
for(let i = 1; i <= 10; i++){
    data.push({
        id: uuid.v4(),
        content: `Esta es la publicacion ${i} del usuario María`,
        userId: '0120e619-3901-440b-a4f9-1e1424fc7e9d'
    });
    data.push({
        id: uuid.v4(),
        content: `Esta es la publicacion ${i} del usuario Juan`,
        userId: '60852707-7741-4492-b34a-14c25b01af9b'
    })
    data.push({
        id: uuid.v4(),
        content: `Esta es la publicacion ${i} del usuario David`,
        userId: '093f85e8-1e84-4e06-967b-714be18ec5b3'
    })
    data.push({
        id: uuid.v4(),
        content: `Esta es la publicacion ${i} del usuario Carmen`,
        userId: '89c7c7f5-f279-4946-ba79-3dd04f819663'
    })
    data.push({
        id: uuid.v4(),
        content: `Esta es la publicacion ${i} del usuario Sara`,
        userId: '7a9e8130-1623-40ba-9f41-edf0d4ad2c75'
    })
    data.push({
        id: uuid.v4(),
        content: `Esta es la publicacion ${i} del usuario Alberto`,
